...
namespace Yodlee.ApiClient.Test.Model
{
    ...
    public class VerifiedAccountsTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" VerifiedAccounts
            //Assert.IsType<VerifiedAccounts>(instance);
        }
