...
namespace Yodlee.ApiClient.Test.Model
{
    ...
    public class ProviderAccountDetailTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" ProviderAccountDetail
            //Assert.IsType<ProviderAccountDetail>(instance);
        }
