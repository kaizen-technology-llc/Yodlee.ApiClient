...
namespace Yodlee.ApiClient.Test.Model
{
    ...
    public class UpdatedProviderAccountTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" UpdatedProviderAccount
            //Assert.IsType<UpdatedProviderAccount>(instance);
        }
