...
namespace Yodlee.ApiClient.Test.Model
{
    ...
    public class DataExtractsHoldingTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" DataExtractsHolding
            //Assert.IsType<DataExtractsHolding>(instance);
        }
