...
namespace Yodlee.ApiClient.Test.Model
{
    ...
    public class EvaluateAccountAddressTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" EvaluateAccountAddress
            //Assert.IsType<EvaluateAccountAddress>(instance);
        }
