...
namespace Yodlee.ApiClient.Model
{
    ...
    /// CobrandLoginRequest
    /// </summary>
    [DataContract(Name = "CobrandLoginRequest")]
    public partial class CobrandLoginRequest : IEquatable<CobrandLoginRequest>, IValidatableObject
    {
        ...
        public CobrandLoginRequest(Cobrand cobrand = default(Cobrand))
        {
            ...
            if (cobrand == null)
            {
                throw new ArgumentNullException("cobrand is a required property for CobrandLoginRequest and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "cobrand", IsRequired = true, EmitDefaultValue = true)]
