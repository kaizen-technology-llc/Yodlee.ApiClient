...
namespace Yodlee.ApiClient.Model
{
    ...
    public partial class ConsentResponse : IEquatable<ConsentResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public List<Consent> Consent { get; private set; }
        ...
        {
            return this.Equals(input as ConsentResponse);
        }
